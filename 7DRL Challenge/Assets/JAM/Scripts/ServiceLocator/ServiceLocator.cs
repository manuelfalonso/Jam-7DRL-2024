...
namespace UnityServiceLocator
{
    public class ServiceLocator : MonoBehaviour
    {
        ...
        public static T FindFirstObjectByType<T>() where T : UnityEngine.Object
        {
            ...
            // If the object is not found in the collection, try using FindObjectsOfType
            T[] foundObjects = UnityEngine.Object.FindObjectsOfType<T>();
            if (foundObjects.Length > 0)
            {
                return foundObjects[0];
            }

            return null; // Return null if no object of the specified type is found
        }
